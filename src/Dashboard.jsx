...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      if (distance < 0) {
        ...
        setTimeLeft(`${days}d ${hours}h`); // Sadece gün ve saat yeterli, daha temiz durur
      }
    }, 1000);
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-gray-300 p-4 md:p-8 font-sans selection:bg-cyan-500/30">
      ...
      {/* HEADER */}
      <header className="max-w-7xl mx-auto mb-8 border-b border-cyan-900/30 pb-6 flex flex-col xl:flex-row justify-between items-center gap-6">
        ...
        {/* ACTION CENTER (Token Bilgileri + Buton) */}
        <div className="flex flex-wrap justify-center gap-4">
            ...
            {/* YENİ: AIRDROP BUTONU (Call to Action) */}
            <motion.a 
